...
## Boxplots 
Here we show how the boxplots showing the experiment were created.
...
# remove outlier samples based on observations  
# Remove rows
...
We used t-test to asses  the connections between the experimental days.
...
We used MANOVA to asses the differneces in the overall experiment
