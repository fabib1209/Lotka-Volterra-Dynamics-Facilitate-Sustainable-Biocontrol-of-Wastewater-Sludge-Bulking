...
We also create a function for plotting.
...
## 03 Using the functions

We use the functions for calculation and plotting in a loop to get everything for every dataset.
